...
organising code for scientific projects that will make your life easier.
...
1.  Start writing in an .R file and use RStudio's command / short cut to
    push current line, selected lines or modified lines to the
...
RStudio is the same as the one you would get if you just typed in `R` in
your commandline environment.
...
Just like bash, if you type in an incomplete command, R will wait for
you to complete it:
...
In this case we've combined the two. Just like the order of operations,
