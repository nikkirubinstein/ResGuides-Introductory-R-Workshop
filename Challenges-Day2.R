...
# Make a new column in the titanic data frame that
# contains Fare rounded to the nearest integer.
...
# reporting whether there are any centenarians (100-year-olds) in the
# titanic dataset. 
# Now do the same for 80-year-olds.
...
## Challenge 3 
# Write a script that loops through the titanic data by passenger class and prints 
# out whether the mean Survived measure is smaller or larger than 8 units.
# Hint: you may want to check out the function na.rm() and unique()

## Challenge 4 
# Modify the script from Challenge 4 to also loop over each sex.
# This time print out whether the Survived measure is
# smaller than 0.2, between 0.2 and 0.6, or greater than 0.6.
